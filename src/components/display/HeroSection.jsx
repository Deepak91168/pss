  ...
  return (
    <div className="m-4 mt-10 sm:max-w-[75%] lg:max-w-[60%] flex justify-between mx-auto border-b-2 pb-4">
      <div className="flex-col mt-6 justify-center item-center">
        ...
        <div
          onClick={openPopup}
          className="mt-4 text-white w-32 justify-center items-center text-sm bg-blue-700 p-2  rounded-lg cursor-pointer hover:bg-blue-900 shadow-md hover:shadow-xl transition-all ease-in-out duration-300"
        >
